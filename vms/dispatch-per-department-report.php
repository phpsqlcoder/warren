                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        if(isset($_GET['start'])) {
                            ...
                            $strQuery = sqlsrv_query($conn,"SELECT top(10) deptId,count(deptId) AS total FROM dispatch
                                WHERE addedDate BETWEEN '$from' AND '$to' GROUP BY deptId ORDER BY total DESC");

                            if ($strQuery) {

                                $arrData = array(
                                    "chart" => array(
                                        "caption" => "TOTAL DISPATCHES PER DEPARTMENT",
                                        "xAxisName" => "",
                                        "showValues" => "1",
                                        "theme" => "fusion"
                                    )
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <tbody>    
                                                ...
                                                if(isset($_GET['start'])){
                                                    ...
                                                    $query = sqlsrv_query($conn,"SELECT top(10) deptId,count(deptId) AS total FROM dispatch WHERE addedDate BETWEEN '$from' AND '$to' GROUP BY deptId ORDER BY total DESC");

                                                    while ($u= sqlsrv_fetch_array($query)) {
                                                        echo '<tr>
                                                        <td>'.strtoupper($u['deptId']).'</td>
