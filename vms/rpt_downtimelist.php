...
As of: <?php echo date('F d,Y');?><br><br><br><br></td>
					...
					<?php 
						...
						$lq=sqlsrv_query($conn,"select top 20 CONVERT(VARCHAR(19),d.dateStart) as ds,CONVERT(VARCHAR(19),d.dateEnd) as de,d.*, (u.equipment + ' ' + u.brand + ' ' + u.model + ' ' + u.type + ' ' + u.plateNo) as uni from downtime d left join unit u on u.id=d.unitId ".$adqry." order by d.id desc");
