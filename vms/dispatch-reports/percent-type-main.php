<?php
   ...
   if(isset($_GET['start'])){
      ...
      $qry = sqlsrv_query($conn,"select u.id,u.type, sum(d.mins) as total from  dispatchflatdata d 
      ...
      while($r = sqlsrv_fetch_array($qry)){
         ...
         $total_query = sqlsrv_query($conn,"select distinct u.id as id from  dispatchflatdata d 
                                 ...
                                 where u.id>0 and u.type='".$r['type']."' ".$cond." "); 
         ...
         $data .= '<tr>
                     <td>'.$seq.'</td>
                     <td>'.$r['type'].'</td>
                     <td align="right">'.number_format($total_availability,2).' hrs</td>
   ...
   <head>
      ...
      FusionCharts.ready(function(){
            var revenueChart = new FusionCharts({
              ...
              "dataSource": {
                 "chart": {
                    "caption": "% Utilization per Vehicle Type",
                    "xAxisname": "Type",
      ...
      <div class="page-container" style="margin-left:5%;">
         <div class="page-content-wrapper">
            <div class="page-content">
               <div class="row">
                  <div class="col-md-12">
                  <h2>Percent Utilization Per Vehicle Type</h2>
