<?php
   ...
   if(isset($_GET['start'])){
      ...
      $qry = sqlsrv_query($conn,"select u.type, sum(d.mins) as total from  dispatchflatdata d 
                                 right join unit u on u.id=d.unitId                               
                                 left join department de on de.id=d.deptId
                                 where u.id>0 ".$cond."
                                 group by u.type
                                 order by sum(d.mins) DESC,u.type");
      ...
      <div class="page-container" style="width:90%;">
         <div class="page-content-wrapper">
            ...
            <?php if($_GET['displaytype']=='full'){ ?>
               <div class="row">
                  <div class="col-md-12">
                     <form action="per-type.php" method="get">
                        <table width="100%">
                           <tr>
                  ...
                  <div class="col-md-12 pull-right">
                     ...
                     <div class="btn-group pull-right">
                        ...
                        <ul class="dropdown-menu pull-right">
                           <li><a href="per-type.php?displaytype=<?php echo $_GET['displaytype'];?>&display=pie2d&start=<?php echo $_GET['start'];?>&end=<?php echo $_GET['end'];?>&unit=<?php echo $_GET['unit'];?>">Pie </a></li>
                           <li><a href="per-type.php?displaytype=<?php echo $_GET['displaytype'];?>&display=bar2d&start=<?php echo $_GET['start'];?>&end=<?php echo $_GET['end'];?>&unit=<?php echo $_GET['unit'];?>">Bar </a></li>
                           <li><a href="per-type.php?displaytype=<?php echo $_GET['displaytype'];?>&display=column2d&start=<?php echo $_GET['start'];?>&end=<?php echo $_GET['end'];?>&unit=<?php echo $_GET['unit'];?>">Column </a></li>
                           <li class="divider"></li>
                           <li><a href="per-type.php?displaytype=<?php echo $_GET['displaytype'];?>&display=list&start=<?php echo $_GET['start'];?>&end=<?php echo $_GET['end'];?>&unit=<?php echo $_GET['unit'];?>">List </a></li>
                        </ul>
                     </div>
                  </div>
               </div>
