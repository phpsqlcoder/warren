...
$iq=sqlsrv_query($conn,"select u.type,sum(man_hours) as total from downtime d left join unit u on u.id=d.unitId
  where d.tdowntime>0 and d.active=1 ".$cond." group by u.type");
$idata='';
