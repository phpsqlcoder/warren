                                 ...
                                 <div class="row">
                                    ...
                                    <?php 
                                       ...
                                       if (isset($_POST['e_user'])) { 
                                            ...
                                            $user = update_duser($domain,$fname,$role,$dept,$id,$department,base64_encode($password));
                                        ...
                                        if (isset($_POST['a_user'])) {
                                            ...
                                            $active      = 1;
                                            $department  = 1;
                                            $password    = base64_encode($_POST['dpassword']);
                                        ...
                                        if ($row_count >= 1)  {
                                            ...
                                            $user = add_duser($domain,$fname,$role,$dept,$isLocked,$active,$department,$password);
                                                if ($user) {
                                    ...
                                    ?>
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                ...
                                                <a class="btn btn-sm blue pull-right" href="department-user-maintenance.php">Add New</a>
                                            </div>
                                            <div class="portlet-body form">
                                                <div class="row">
                                                    <div class="col-md-12 well">
                                                        <div class="form-group">
                                                            <input class="form-control" type="text" name="search" id="search" placeholder="Search Department"/>
                                                        </div>
                                                        <div id="result"></div>
                                                    </div>
                                                    <form action="" method="post">
                                                        <div class="col-md-12">
                                                            ...
                                                            <?php if (isset($_GET['dept']) || isset($_GET['id'])) { ?> 
                                                                <div class="row">  
                                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="row">
                                                              ...
                                                              <div class="col-md-6">
                                                                <?php 
                                                                    if(isset($_GET['id'])){
                                                                        $row = sqlsrv_fetch_array(sqlsrv_query($conn,"SELECT dpassword FROM users WHERE id = '".$_GET['id']."' "));
                                                                        $password = base64_decode($row['dpassword']);
                                                                        echo "<label class=\"control-label\">Password</label>";
                                                                        echo "<input required type=\"password\" class=\"form-control\" name=\"dpassword\" value=\"$password\"/>";
                                                                    } else if(isset($_GET['dept'])) {
                                                                        echo "<label class=\"control-label\">Password</label>";
                                                                        echo "<input required type=\"password\" class=\"form-control\" name=\"dpassword\"/>";
                                                                    }
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <?php 
                                             ...
                                             if (isset($_POST['activate'])) {
                                                ...
                                                $user = activate_selected_duser($id);
                                             ...
                                             if (isset($_POST['deactivate'])) {
                                                ...
                                                $user = deactivate_selected_duser($id);
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                    ...
                                                    $query = get_all_dusers();
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="btn btn-circle btn-sm blue" href="department-user-maintenance.php?id=<?=$id;?>">
