<?php
   ...
   if(isset($_GET['act'])){
      $resource = sqlsrv_query($conn,"insert into vehicle_request (name,dept,date_needed,purpose,costcode,addedBy,addedAt,origin,destination,status)
         values ('".$_SESSION['esdvms_name']."','".$_SESSION['dept']."','".date('Y-m-d H:i:s',strtotime($_POST['date_needed']))."',
         '".$_POST['purpose']."','".$_POST['purpose']."','".$_SESSION['esdvms_username']."','".date('Y-m-d H:i:s')."',
         '".$_POST['from']."','".$_POST['to']."','Request Submitted'); SELECT SCOPE_IDENTITY()
         ");
      ...
      header("location: request_list_requestor.php");
   }
      ...
      <div class="page-container">
         ...
         <div class="page-content-wrapper">
            <div class="page-content">               
               ...
               <div class="modal fade" id="editrequest" tabindex="-1" role="editrequest" aria-hidden="true">
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <form method="post" action="request_list_requestor.php?act=submit">
                           <div class="modal-header">
                  ...
                  <div class="col-md-12">
                     <div class="portlet box blue-steel">
                        <div class="portlet-title">
                           ...
                           <div class="actions">
                              <div class="btn-group">
                                 <a class="btn blue" href="#" style="margin-left: 10px;" onclick="$('#newrequest').modal('show');">
                                    Add New
                                 </a>
                                 ...
                                 <tbody>
                                    <?php
                                       ...
                                       $lq=sqlsrv_query($conn,"select CONVERT(VARCHAR(19),date_needed) as needed,CONVERT(VARCHAR(19),addedAt) as added,*                                     
                                          from vehicle_request where dept='".$_SESSION['dept']."' order by id desc");
                                       while($l=sqlsrv_fetch_array($lq)){      
                                          ...
                                          echo '
                                             <tr>
                                                ...
                                                <td>'.$l['purpose'].'</td>       
                                                <td>'.$l['status'].'</td> 
                                                <td><a href="comments.php?id='.$l['id'].'">'.$comments['comment'].'</a></td>                                        
