               ...
               <form method="get" act="index.php">
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        <h3 class="page-title">
                           Request List      <a href="#" onclick="tose();">test</a>                                               
                        </h3>                        
                     </div>
                  </div>
               </form>
                              ...
                              <table style="font-size:11px;" class="table table-striped table-bordered table-hover" id="sample_4">
                                 <thead>
                                    <tr>
                                       ...
                                       <th width="8%">Date Needed</th>
                                       <th width="8%">Date Requested</th>
                                       <th width="8%">Origin</th>
                             
                                       <th width="15%">Purpose</th>   
                                       <th width="8%">Last Message</th>            
                                       <th width="7%">Status</th>
                                       <th width="30%">Trip Ticket - <small>Legends:</small> 
                                          <span class="label label-primary">New/Not Printed</span>
                                          <span class="label label-warning">Printed/Issued</span>
                                          <span class="label label-danger">Cancelled</span>
                                          <span class="label label-success">Closed/Completed</span>
                                       </th>                       
                                 ...
                                 <tbody>
                                    <?php
                                       ...
                                       ?>
                                             ...
                                             <tr>
                                                <td><a href="../request_view.php?id=<?php echo $l['id'];?>" ><?php echo $l['refcode']; ?></a></td>
                                                <td><?php echo date('Y-m-d h:i A',strtotime($l['needed'])); ?></td>
                                                <td></td>
                                                <td><?php echo $l['origin']; ?></td>       
                                                   ...
                                                   <?php 
                                                      $tid = sqlsrv_query($conn,"SELECT tripTicket, isPrinted, Status FROM dispatch WHERE request_id = '".$l['id']."' ");
                                                         while($t = sqlsrv_fetch_array($tid)){
                                                            ...
                                                            echo '<a href="dispatch_details.php?id='.$tt.'" class="btn btn-xs '.$color.'">'.$tt.'</a>&nbsp;';
                                                         }  
                                                   ?>
                                                </td>                                           
                                                <td style="width:100px;">
                                                   <!-- <a href="#" class="btn purple btn-xs hide" onclick='window.open("downtime_edit.php?id='.$l['id'].'","displayWindow","toolbar=no,scrollbars=yes,width=1200,height=700"); return false;\';><i class="fa fa-edit "></i>
                                                   </a> -->
                                                   <a href="#" class="btn red btn-xs deletedl hide" onclick="deleted('.$l['id'].');">
                                                      <i class="fa fa-minus-circle"></i>
                                                   </a>
                                                   <a href="dispatch_add.php?id=<?php echo urlencode($l['id']) ?>" class="btn green btn-xs">
                                                      <i class="fa fa-truck"></i>
                                                   </a>
                                                   <a href="#" class="btn purple btn-xs dropdown-quick-sidebar-toggler" id="<?php echo $l['id'];?>">
