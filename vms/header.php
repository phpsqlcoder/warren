	...
	<div class="page-header-inner">
		...
		<div class="hor-menu hidden-sm hidden-xs">
			<ul class="nav navbar-nav">	
							...
							<div class="mega-menu-content">
								<div class="row">
									<ul class="col-md-6 mega-menu-submenu">
										...
										<li>
											<a href="<?php echo $url;?>utilization/request_list.php?addNewRequest=go">
											<i class="fa fa-plus"></i> Add Request
											</a>
										</li>
										<li>
											<a href="<?php echo $url;?>utilization/drivers.php">
									...
									<ul class="col-md-6 mega-menu-submenu">
										...
										<li><a href="<?php echo $url;?>dispatch-per-department-report.php"><i class="fa fa-building-o"></i> Dispatchs Distribution per Department</a></li>
										...
										<li><a href="<?php echo $url;?>rpt-trip-ticket-no.php"><i class="fa fa-tags"></i> Trip Tickets</a></li>
										<li><a href="<?php echo $url;?>vehicle-request-raw-data.php"><i class="fa fa-tags"></i> Vehicle Request Raw Data</a></li>
									</ul>
				...
				<li><a>|</a></li>
				<?php if($_SESSION['esdvms_role'] == 'admin') { ?>
				<li class="mega-menu-dropdown">
					<a data-hover="dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;" class="dropdown-toggle">
					...
					<ul class="dropdown-menu">
						<li>
							...
							<div class="mega-menu-content">
								<div class="row">
									<ul class="col-md-6 mega-menu-submenu">
										<li><a href="<?php echo $url;?>maintenance.php"><i class="fa fa-file"></i> Vehicle Maintenance</a></li>
										<li class="dropdown-submenu">
											<a href="javascript:;">
												<i class="fa fa-lock"></i> User Maintenance </a>
												<ul class="dropdown-menu">	
						          					<li><a href="<?php echo $url;?>user-maintenance.php"><i class="fa fa-user"></i> Individual User Maintenance</a></li>
						          					<!-- <li><a href="fuel-maintenance.php"><i class="fa fa-fire"></i> Fuel Maintenance</a></li> -->
						          					<li><a href="<?php echo $url;?>department-user-maintenance.php"><i class="fa fa-users"></i> Department User Maintenance</a></li>
						          				</ul>
				          				</li>
									</ul>
		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">				
				...
				<li class="dropdown dropdown-quick-sidebar-toggler" style="color:white;">
					...
					<input type="hidden" value="<?php echo $url;?>" name="hidden_url" id="hidden_url">
				</li>
...
<link rel="stylesheet" type="text/css" href="<?php echo $url;?>metronic/assets/global/plugins/bootstrap-toastr/toastr.min.css"/>
