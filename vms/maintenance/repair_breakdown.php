...
include("../config.php");
session_start();
$url = "repair_breakdown.php";
$table = "repair_breakdown";
$msg = '';
						...
						<div class="tabbable portlet-tabs">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="portlet_tab_1">
									<a href="#" class="btn green btn-xs" onclick='window.open("export.php?act=repair_breakdown", "Maintenance", "width=800,height=600")'>Export to Excel</a>
									<?php 
										if(isset($_GET['act'])){
											if($_GET['act']=='edit'){
									?>
