...
if(isset($_GET['act'])){
	if($_GET['act']=='save'){
		...
		$insert = sqlsrv_query($conn,"insert into ".$table." (status,active)
	...
	if($_GET['act']=='update'){
		...
		$update = sqlsrv_query($conn,"update ".$table." set status='".htmlentities($_POST['name'])."' where id='".$_GET['id']."'");
						...
						<div class="tabbable portlet-tabs">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="portlet_tab_1">
									<a href="#" class="btn green btn-xs" onclick='window.open("export.php?act=status", "Maintenance", "width=800,height=600")'>Export to Excel</a>
									<?php 
										if(isset($_GET['act'])){
											if($_GET['act']=='edit'){
									?>
												...
												<form action="<?php echo $url; ?>?act=update&id=<?php echo $_GET['id'];?>" method="POST">
													<div class="row">
														<div class="col-md-12 margin-bottom-10">
															...
															<div class="col-md-9">
																<input type="text" size="16" name="name" id="name" class="form-control" value="<?php echo $e['status'];?>" required="required">
															</div>
														</div>
													</div>													
