...
if(isset($_GET['act'])){
	...
	// end AD checking
		...
		if ($authUser == true) { // if correct
		    ...
		    $qry=sqlsrv_fetch_array(sqlsrv_query($conn,"SELECT * FROM users WHERE domain='".$_POST['logname']."' and active=1"));
			if($qry['id']){
				session_start();
	...
	<form class="login-form" action="login.php?act=login" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Domain name" name="logname" id="logname"/>
			</div>
		</div>
		<div class="form-group">
