            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3 class="page-title">
                            <i class="fa fa-certificate"></i> TOP 10 <small>&nbsp;&nbsp;Vehicles by count of number of dispatches</small>                           
                        </h3>
                    </div>
                </div>
                <div class="clearfix"></div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        if(isset($_GET['start'])) {
                            ...
                            $strQuery = sqlsrv_query($conn,"SELECT TOP(10) type,count(type) AS total FROM dispatch WHERE addedDate BETWEEN '$from' AND '$to' GROUP BY type ORDER BY total DESC");

                            if ($strQuery) {

                                $arrData = array(
                                    "chart" => array(
                                        "caption" => "TOTAL NO. OF DISPATCHES PER VEHICLE",
                                        "xAxisName" => "",
                                        "showValues" => "1",
                                        "theme" => "fint"
                                    )
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                                        ...
                                        <tbody>    
                                            ...
                                            if(isset($_GET['start'])){
                                                ...
                                                $query = sqlsrv_query($conn,"SELECT TOP(10) type,count(type) AS total FROM dispatch WHERE addedDate BETWEEN '$from' AND '$to' GROUP BY type ORDER BY total DESC");

                                                while ($u= sqlsrv_fetch_array($query)) {
                                                    echo '<tr>
                                                    <td>'.strtoupper($u['type']).'</td>
                                                    <td>'.strtoupper($u['total']).'</td>
                                                    </tr>';
                                                }
                                            }
                                            ?>   
