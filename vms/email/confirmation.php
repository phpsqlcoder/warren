						...
						<tr>
							<td>
								...
								<table style="margin-left:20px;" width="100%">
									<tr>
										<td>User:</td>
										<td style="font-weight: bold;font-size:18px;"><?php echo $_GET['name'];?></td>
									</tr>
									<tr>
										<td>Category:</td>
									...
									<tr>
										<td>Issue:</td>
										<td style="font-weight: bold;">Check Login Details of <?php echo $_GET['name'];?></td>
									</tr>
							...
							<td class="wrapper">
								...
								<tr>
									<td class="vertical-middle">
										 &copy; Philsaga Mining Corporation  <?php echo date('Y');?>
									</td>
								</tr>
								</table>
							</td>
